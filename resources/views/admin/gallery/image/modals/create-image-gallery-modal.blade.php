<!-- Modal-->
<div class="modal fade" id="imageGalleryCreateModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="imageGalleryCreateModalForm" data-uuid="{{ $gallery?->uuid }}">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="imageGalleryCreateModalButton" class="btn btn-primary font-weight-bold">Kaydet</button>
            </div>
        </div>
    </div>
</div>
