<div class="modal fade" id="galleryUpdateModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
<div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Galeri Oluştur</h5>
                ...
                <form id="galleryUpdateForm">
                    ...
                    <div class="form-group">
                        <div class=" text-center">
                            ...
                            <div class="image-input image-input-outline" id="file_update">
                                ...
                                <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Kapak Görselini değiştir">
                                    ...
                                    <input type="file" name="file_update" accept=".png, .jpg, .jpeg"/>
                    ...
                    <div class="form-group row justify-content-between">
                        <label for="gallery_type">Galeri Türü</label>
                        <select name="type" id="gallery_type" class="form-control select2">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="galleryUpdateModalButton" class="btn btn-primary font-weight-bold">Kaydet</button>
            </div>
        </div>
    </div>
</div>
