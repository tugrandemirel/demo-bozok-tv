<div class="modal fade" id="surveyQuestionModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Soru Oluştur</h5>
            ...
            <div class="modal-body">
                ...
                <form id="surveyQuestionStoreForm" data-survey-uuid="{{ $survey?->uuid }}">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="surveyQuestionStoreButton" class="btn btn-primary font-weight-bold">Kaydet</button>
            </div>
        </div>
    </div>
</div>
