    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-{{ $galleriesToggle ?? '' }}" aria-haspopup="true">
                ...
                <li class="menu-item menu-item-{{ $surveysToggle ?? '' }}" aria-haspopup="true">
                ...
                <li class="menu-item menu-item-{{ $adsToggle ?? '' }}" aria-haspopup="true">
