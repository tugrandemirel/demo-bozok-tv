<div class="card card-custom gutter-b">
    <div class="card-body text-center">
        ...
        <div class="image-input image-input-outline" id="cover_image">
            <div class="image-input-wrapper" style="background-image: url({{ asset('/storage/'.$cover_image?->path) }})"></div>
    ...
    <div class="card-body text-center">
        ...
        <div class="image-input image-input-outline" id="inside_image">
            <div class="image-input-wrapper" style="background-image: url({{ asset('/storage/'.$inside_image?->path) }})"></div>
