...
@section('content')
    ...
    <div class="card-flush pt-5">
        <form id="newslettersFormUpdate" enctype="multipart/form-data" data-uuid="{{ $newsletter->uuid }}">
            <div class="row">
                <div class="col-md-2">
                   @include('admin.newsletter.edit.partials.left')
                </div>
                <div class="col-md-10">
                    @include('admin.newsletter.edit.partials.right')
                </div>
            </div>
            <div class="row">
