<!-- Modal-->
<div class="modal fade" id="categoryCreateModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary font-weight-bold" id="categoryCreateModalButton">Kaydet</button>
            </div>
        </div>
    </div>
</div>
