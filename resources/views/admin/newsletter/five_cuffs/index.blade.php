@php
    ...
    $newsletterFiveCuffsToggle = 'menu-item-active';
@endphp
@extends('admin.layouts.app')
@section('title', 'Beşli Manşetleri')
@push('css')
    ...
    <div class="subheader py-2 py-lg-6  subheader-solid " id="kt_subheader">
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Beşli Manşetleri</h5>
                <!--end::Page Title-->
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-label">Beşli Manşetleri</h3>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="newsletters_five_cuffs_datatable" class="table align-middle table-row-dashed fs-6 gy-5">
                    <thead>
