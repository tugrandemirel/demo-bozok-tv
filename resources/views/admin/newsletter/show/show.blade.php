                    ...
                    <ul class="navi navi-hover">
                       {{-- <li class="navi-header font-weight-bold py-4">
                        ...
                        <li class="navi-item mb-3">
                            <a href="{{ route('admin.newsletters.edit', ['newsletter_uuid' => $newsletter?->uuid]) }}" class="navi-link">
...
{{--                        </li>--}}
    ...
    <div class="card card-custom border-left-{{ \App\Helpers\Custom\CustomHelper::getNewsletterPublicationStatusLabelColor($newsletter->code) }}">
        <div class="card-header ribbon ribbon-clip ribbon-right">
           @include('admin.newsletter.show.partials.card-header')
        </div>
        <div class="card-body">
            @include('admin.newsletter.show.partials.card-body')
        </div>
    </div>
    @include('admin.newsletter.show.modals.status-modal')
@endsection
@push('js')
    @vite([
