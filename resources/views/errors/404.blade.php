...
<div class="d-flex flex-column flex-root">
    ...
    <div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{ asset("assets/media/error/bg5.jpg") }});">
        ...
        <div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
            ...
            <p class="font-weight-boldest display-4">Sayfa bulunamadı. Bir şeyler yanlış gitti.</p>
            <p class="font-size-h3">Üzerinde çalışıyoruz. Lütfen iletişime geçiniz.</p>
        </div>
        <!--end::Content-->
    </div>
    <!--end::Error-->
