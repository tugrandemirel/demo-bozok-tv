...
"use strict"
let QuestionsDatatablesDataSourceAjaxServer = function () {

    let initTable = function () {
        let questions_datatable = $('#questions_datatable');
        let survey_uuid = questions_datatable.data('survey-uuid')
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            ...
                            <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm delete-question-modal" data-question-uuid="${row?.survey_question_uuid}">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
...
$(document).ready(function () {
    QuestionsDatatablesDataSourceAjaxServer.init();
});
