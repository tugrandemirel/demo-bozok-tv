...
"use strict"
let NewslettersOutstandingsDatatablesDataSourceAjaxServer = function () {

    let initTable1 = function () {
        let newsletters_datatable = $('#newsletters_outstandings_datatable');
        ...
        newsletters_datatable.DataTable({
          ...
          <'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
            ...
            "ordering": true,
            ajax: {
                url: '/admin/dashboard/newsletters/outstandings',
                type: 'POST',
            },
            columns: [
                {
...
$(document).ready(function () {
    NewslettersOutstandingsDatatablesDataSourceAjaxServer.init();
});
