...
"use strict"
let NewslettersLastMinutesDatatablesDataSourceAjaxServer = function () {

    let initTable1 = function () {
        let newsletters_datatable = $('#newsletters_last_minutes_datatable');
        ...
        newsletters_datatable.DataTable({
          ...
          <'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
            ...
            "ordering": true,
            ajax: {
                url: '/admin/dashboard/newsletters/last-minutes',
                type: 'POST',
            },
            columns: [
                {
...
$(document).ready(function () {
    NewslettersLastMinutesDatatablesDataSourceAjaxServer.init();
});
